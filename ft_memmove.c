...
int test_compare(const char *test_name, void *result, void *expected, size_t size, int should_pass) {
...
void test_null_pointers() {
    ...
    test_compare("NULL destination", &result1, &(void*){NULL}, sizeof(void*), 0);
...
void test_different_types() {
    ...
    test_compare("Integer array copy", dest_int, expected_int, 5 * sizeof(int), 1);
    ...
    test_compare("Struct copy", &dest_struct, &expected_struct, sizeof(struct Point), 1);
}
